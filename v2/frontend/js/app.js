...
import { customersPage } from "./customers.js?v=20260831-27";
import { activityPage } from "./activity.js?v=20260829-25";
import {
  checklistItemCount,
  checklistPage,
} from "./checklist.js?v=20260829-29";
import { closingPage, commissionPage } from "./finance.js?v=20260831-39";
import { performancePage } from "./performance.js?v=20260831-92";
...
import { adminPage, isAppAdmin } from "./admin.js?v=20260831-14";
import {
  loadManualLinks,
  mergeManualLinks,
  addManualLink,
...
const SYNC_DOWNLOAD =
  "https://raw.githubusercontent.com/prepaid1215/nr-manage/main/v2/sync-client/installer/NRCSync.exe";
